...
from .view_webhook import (webhook_asterisk_entrante, webhook_estado_llamada,
                           webhook_llamada_entrante)
...
urlpatterns = [path(item['url'], item['vista']) for item in telefonia_urls] + [
    ...
    path('webhook/asterisk/', webhook_asterisk_entrante, name='webhook_asterisk'),
